...
<div class="container-fluid w-50 text-center">
    <h3 class="text-center text-primary fw-bold mt-5">Danh Sách Dịch Vụ</h3>
...
<%--                    <td>${item.donViTinh}</td>--%>
        ...
        <div class="mt-3">
            ...
            <a class="btn btn-primary float-end" href="${pageContext.request.contextPath}/khach-hang/list">Danh Sách Khách Hàng</a>
        </div>
    </div>
</div>
</body>
